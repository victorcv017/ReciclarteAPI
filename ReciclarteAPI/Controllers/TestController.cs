    ...
    public class TestController : ControllerBase
    {
        ...
        public async Task<IActionResult> Test()
        {
            ...
            var user = new Users {
                ...
                UserName = "hernandunogames@gmail.com",
                Email = "hernandunogames@gmail.com",
                Curp = "HEHA960319HOCRRN02",
                Address = dir,
            ...
            var oxxo = new Enterprises() { UserName = "contacto@oxxo.com", Name = "Oxxo", Email = "contacto@oxxo.com", Logo = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Oxxo_Logo.svg/1200px-Oxxo_Logo.svg.png" };
            ...
            await _userManager.ConfirmEmailAsync(oxxo, await _userManager.GenerateEmailConfirmationTokenAsync(oxxo));
            await _userManager.ConfirmEmailAsync(chedraui, await _userManager.GenerateEmailConfirmationTokenAsync(chedraui));
            await _userManager.ConfirmEmailAsync(aurrera, await _userManager.GenerateEmailConfirmationTokenAsync(aurrera));
            ...
            await _userManager.ConfirmEmailAsync(office, await _userManager.GenerateEmailConfirmationTokenAsync(office));
            ...
            await _userManager.ConfirmEmailAsync(center, await _userManager.GenerateEmailConfirmationTokenAsync(center));

            dir = new Addresses() { City = "Oaxaca", Township = "Oaxaca de Juarez", PC = 68740, Number = 1, Street = "San Rafael Lote 2" };
            var center2 = new Centers() { UserName = "reciclaje@corecicladora.com", Email = "reciclaje@corecicladora.com", Name = "Comercial Recicladora", Schedule = new Schedule() { Lu = "08:00–18:00", Ma = "08:00–18:00", Mi = "08:00–18:00", Ju = "08:00–18:00", Vi = "08:00–18:00", Sa = "08:00–18:00", Do = "Cerrado" }, Address = dir, Point = new Point() { Lat = 17.070880, Long = -96.726108 } };
            await _userManager.CreateAsync(center2, "Aa12345SDFCENT2.6!!");

            await _userManager.ConfirmEmailAsync(center2, await _userManager.GenerateEmailConfirmationTokenAsync(center2));
            ...
            dir = new Addresses() { City = "Oaxaca", Township = "Oaxaca de Juarez", PC = 68030, Number = 125, Street = "Francisco I. Madero" };
            center = new Centers() { UserName = "reciclarte@ito.com", Email = "reciclarte@ito.com", Name = "Instituto Tecnológico de Oaxaca", Schedule = new Schedule() { Lu = "08:00–20:00", Ma = "08:00–20:00", Mi = "08:00–20:00", Ju = "08:00–20:00", Vi = "08:00–20:00", Sa = "08:00–20:00", Do = "Cerrado" }, Address = dir, Point = new Point() { Lat = 17.077313, Long = -96.744437 } };
            await _userManager.CreateAsync(center, "Aa12345SDFCENT.6!!");
            ...
            await _userManager.ConfirmEmailAsync(proveedora, await _userManager.GenerateEmailConfirmationTokenAsync(proveedora));
            ...
            await _userManager.ConfirmEmailAsync(asun, await _userManager.GenerateEmailConfirmationTokenAsync(asun));

            dir = new Addresses() { City = "Oaxaca", Township = "Oaxaca de Juarez", PC = 68000, Number = 1001, Street = "Av. Independencia" };
            office = new Offices { UserName = "proveedora1@proveedora.com", Email = "proveedora1@proveedora.com", Address = dir, Enterprise = proveedora, Point = new Point() { Lat = 17.061563, Long = -96.722438 }, Schedule = new Schedule() { Lu = "09:00–20:00", Ma = "09:00–20:00", Mi = "09:00–20:00", Ju = "09:00–20:00", Vi = "09:00–20:00", Sa = "09:00–20:00", Do = "09:00–16:00" } };
            await _userManager.CreateAsync(office, "Aa12345SDFAURRE.6!!");
